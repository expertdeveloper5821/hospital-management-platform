    ...
    <tr>
      <td align="center">
        <table width="560" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.08);max-width:560px;width:100%;">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              <h2 style="margin:0 0 12px;color:#111827;font-size:18px;font-weight:600;">Your account has been created</h2>
              <p style="margin:0 0 20px;color:#4b5563;font-size:15px;line-height:1.6;">
                An account has been created for you on the Hospital Management System. Use the details below to sign in for the first time.
              </p>
              ...
              <table cellpadding="0" cellspacing="0" width="100%" style="margin:0 0 24px;border:1px solid #e5e7eb;border-radius:6px;">
                ...
                <tr>
                  <td style="padding:14px 16px;color:#6b7280;font-size:13px;">Temporary Password</td>
              ...
              <p style="margin:0 0 8px;color:#4b5563;font-size:14px;line-height:1.6;">
                <strong>How to create your own password:</strong>
              </p>
              <ol style="margin:0 0 20px;padding-left:20px;color:#4b5563;font-size:14px;line-height:1.7;">
                <li>Open the login page using the button above.</li>
                <li>Sign in with your login email and the temporary password shown above.</li>
                <li>You will be prompted to set a new password of your choice before you can continue.</li>
              </ol>

              <p style="margin:0 0 24px;word-break:break-all;">
                If the button above doesn't work, copy and paste this URL into your browser:<br>
                <a href="${loginUrl}" style="color:#1A73E8;font-size:12px;">${loginUrl}</a>
              </p>

              <hr style="border:none;border-top:1px solid #e5e7eb;margin:0 0 24px;">
              <p style="margin:0;color:#9ca3af;font-size:12px;line-height:1.6;">
                For your security, please do not share your temporary password with anyone. If you did not expect this email, please contact your administrator.
              </p>
            </td>
          </tr>
        ...
        <table width="560" cellpadding="0" cellspacing="0" style="background-color:#ffffff;border-radius:8px;overflow:hidden;box-shadow:0 1px 4px rgba(0,0,0,0.08);max-width:560px;width:100%;">
          ...
          <tr>
            <td style="padding:40px 40px 32px;">
              ...
              <p style="margin:0 0 20px;color:#4b5563;font-size:15px;line-height:1.6;">
                A password reset was requested for your HMS account. Click the button below to choose a new password.
              </p>
              ...
              <p style="margin:0 0 24px;word-break:break-all;">
                <a href="${resetLink}" style="color:#1A73E8;font-size:12px;">${resetLink}</a>
              </p>
